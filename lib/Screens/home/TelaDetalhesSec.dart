...
class TelaDetalhesSec extends StatefulWidget {
  final String idSecretaria;

  const TelaDetalhesSec({Key key, this.idSecretaria}) : super(key: key);

  @override
  _TelaDetalhesSecState createState() => _TelaDetalhesSecState();
}

class _TelaDetalhesSecState extends State<TelaDetalhesSec> {
  String id;
  String _urlBase = "https://industria-banco-de-dados.herokuapp.com";

  List<Secretaria> _secretaria;
  Future<List<Secretaria>> _getSecretaria() async {
    try {
      List<Secretaria> listSecretaria = [];
      final response = await http
          .get(_urlBase + "/api/secretaria/?id=${widget.idSecretaria}");
